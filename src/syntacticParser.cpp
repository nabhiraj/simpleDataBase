...
bool syntacticParse()
{
    ...
    //this if condition is added by me.
    ...
    if (possibleQueryType == "CLEAR")
        ...
        return syntacticParseTANSPOSEMATRIX();
...
void ParsedQuery::clear()
{
    ...
    this->loadMatrixRelationName="";//added my me
    this->transposeRelationName="";//added
    this->bulkInsertFilePath="";//added
    this->bulkInsertRelationFileName="";//added
    this->bulkInsertRelationName="";//added
    this->insertRelationName="";//added.
