...
Cursor::Cursor(string tableName, int pageIndex)
{
    ...
    //this->indexTypeUsed=tableCatalogue.getTable(tableName)->indexUsed;//this code is not yet tested.
}
...
//we hava to create our own tiney data struture and each row feching can be from different block.
/**
