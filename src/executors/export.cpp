...
bool semanticParseEXPORT()
{
    ...
    //Table should exist
    if (tableCatalogue.isTable(parsedQuery.exportRelationName)||Matrix::getMatrix(parsedQuery.exportRelationName)!=NULL)
        return true;
...
void executeEXPORT()
{
    ...
    Matrix* mymatrix=Matrix::getMatrix(parsedQuery.exportRelationName);
    if(mymatrix!=NULL){
        mymatrix->makePermanent();
    }
